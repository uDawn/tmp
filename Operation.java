...
public class Operation {
    ...
    private Channel constructChannel(String name, HFClient client, SampleOrg sampleOrg) throws Exception {
        ...
        ChannelConfiguration channelConfiguration = new ChannelConfiguration(new File(FIXTURES_PATH + "/sdkintegration/e2e-2Orgs/channel/foo.tx"));
    ...
    private void instantiateChaincode(HFClient client, Channel channel, SampleOrg sampleOrg) {
        ...
        try {
            ...
            */
            ...
            chaincodeEndorsementPolicy.fromYamlFile(new File(FIXTURES_PATH + "/sdkintegration/chaincodeendorsementpolicy.yaml"));
